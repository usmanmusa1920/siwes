    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training_receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_receiver', to=settings.AUTH_USER_MODEL)),
                ('training_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_sender', to=settings.AUTH_USER_MODEL)),
