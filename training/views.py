...
def registerTrainingCoordinator(request):
  ...
  return render(request, 'training/register_training_coordinator.html', context)


def activateTrainingCoordinator(request, staff_user_id):
...
def filterStaffUser(request):
  ...
  return render(request, 'training/filter_staff_user.html', context=context)
